...
const UniDropDown = ({ onChange }: { onChange: (value: string) => void }) => {
  return (
    <Select onValueChange={onChange}>
...
const Card_Bur_est = ({ onChange }: CardBurEstProps) => {
  return (
    <Card>
      <CardContent className="mt-4">
        <div className="grid gap-6 sm:grid-cols-6">
          ...
          <div className="grid gap-3 ">
            ...
            <FloorDropDown onChange={(value) => onChange('floor', value)} />
          </div>
          <div className="grid gap-3 ">
            <Label htmlFor="units">Offices</Label>
            <UniDropDown onChange={(value) => onChange('units', value)} />
          </div>
          <div className="grid gap-3 ">
          ...
          <div className="grid gap-3 justify-center">
            <CheckBoxPr title={"Ascenseur"} onChange={(value) => onChange('elevator', value)} />
          </div>
