...
const NonSubEst =() => {
    ...
    <MaxWidthWrapper className='max-w-7xl justify-center'>
        ...
        <TabsContent value="appartements"><Card_app_est/></TabsContent>
        <TabsContent value="maisons"><Card_Mai_est/></TabsContent>
        <TabsContent value="villas"><Card_Vill_est/></TabsContent>
        <TabsContent value="bureaux"><Card_Bur_est/></TabsContent>
        <TabsContent value="locaux-commerciaux"><Card_Loc_est/></TabsContent>
        </Tabs>
