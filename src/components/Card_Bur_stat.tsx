...
type CardBurStatProps = {
  category: string;
  city: string;
};

const Card_Bur_stat = ({ category, city }: CardBurStatProps) => {
  return (
    <main className="flex flex-col gap-4 p-4">
      <div className="grid gap-4 max-w-6xl grid-cols-2">
        ...
        <ChartCard title="Prix par rapport à l&apos;Étage">
          <ByDayChart category={category} city={city} />
        </ChartCard>
        <ChartCard title="Prix par rapport au nombre d&apos;Offices">
          <ByDayChart category={category} city={city} />
        </ChartCard>
